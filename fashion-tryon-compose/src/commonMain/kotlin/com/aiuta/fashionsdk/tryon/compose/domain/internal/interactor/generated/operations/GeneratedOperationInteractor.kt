...
internal interface GeneratedOperationInteractor {
    ...
    companion object {
        ...
        fun getInstance(dataProvider: AiutaImageSelectorUploadsHistoryDataProvider): GeneratedOperationInteractor = HostGeneratedOperationInteractor.getInstance(dataProvider)
    }
}

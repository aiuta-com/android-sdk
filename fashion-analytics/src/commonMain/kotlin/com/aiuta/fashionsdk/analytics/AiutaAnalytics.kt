...
import com.aiuta.fashionsdk.analytics.internal.AiutaAnalyticsImpl
 ...
 * manually creating an [AiutaAnalytics] instance.
 *
 * ```kotlin
 ...
 * ```
 *
 * @return [AiutaAnalytics] instance configured for this [Aiuta] instance
 *
 * @see AiutaAnalytics
 * @see AiutaAnalyticsEvent
 */
public val Aiuta.analytics: AiutaAnalytics
    get() = AiutaAnalyticsImpl.create(aiuta = this)
 ...
 * @see Aiuta.analytics
 */
public interface AiutaAnalytics {
    /**

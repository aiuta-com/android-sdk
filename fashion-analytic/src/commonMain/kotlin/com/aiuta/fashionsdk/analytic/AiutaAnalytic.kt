 ...
 *     when (event) {
 *         is AiutaAnalyticOnboardingEvent -> {
...
public interface AiutaAnalytic {
     ...
     *
     * This flow emits [ExternalAnalyticEvent] instances whenever significant
     ...
     *     .launchIn(scope)
     * ```
     * @return Cold [Flow] of [ExternalAnalyticEvent]
     *
     * @see ExternalAnalyticEvent
     */
